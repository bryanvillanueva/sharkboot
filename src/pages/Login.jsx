// src/pages/Login.jsx – versión híbrida con diseño Tailwind + funcionalidad completa
...
const Login = () => {
  ...
  // Detectar token en la URL y guardar en localStorage
  useEffect(() => {
  ...
  const handleFacebook = () => {
    window.location.href = `${BACKEND}/auth/facebook?redirect=${encodeURIComponent(REDIRECT)}`;
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <button
            ...
            className="w-full bg-blue-800 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-900 focus:ring-4 focus:ring-blue-200 transition-all duration-200 flex items-center justify-center"
          >
